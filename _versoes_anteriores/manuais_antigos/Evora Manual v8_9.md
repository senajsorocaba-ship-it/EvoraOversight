...
> Versão 8.9 · 07/07/2026 · numeração contínua · Confidencial — propriedade intelectual de Eng. de Sistemas Luiz Gonzaga Filho
...
O **Évora Oversight** é um ecossistema de inteligência política que acompanha todo o ciclo de uma autoridade — mandato, campanha, segurança e relação com o cidadão. São cinco produtos coordenados por duas IAs principais (Bia e Nil) e 25 agentes, sobre infraestrutura soberana de dados e segurança.
...
| --- | --- | --- |
| Municipal | Diário Oficial Eletrônico de Sorocaba; jornais de Sorocaba (ex.: Jornal Cruzeiro, Jornal do Município); portal e pauta da Câmara de Sorocaba; PNCP (contratos/licitações) | MVP (L1) |
...
**Caixa de Solicitação de Novas Fontes (porta de entrada sempre aberta).** Qualquer assessor — mesmo sem alçada de liberação — que precise de uma **nova fonte de pesquisa diária** (um jornal, um portal, um Diário Oficial, uma norma) pode **registrar o pedido numa caixa própria**; a solicitação vai **automaticamente para quem tem alçada de liberação**, que aprova ou recusa. Ao aprovar, a fonte entra no monitoramento marcada como "nova / a validar" até a autoridade confirmar. Todo o fluxo — pedido, quem liberou, quando — fica na trilha imutável (Aegis). Isso vale tanto para as **fontes de pesquisa diária** (AIM-g / Veritas-Dados) quanto para o **Veritas — Acervo Legal-Normativo** (inclusão de normas e novas fontes normativas sempre possível). Assim, o Évora nunca fica preso a um conjunto fixo de fontes: ele cresce com a necessidade do gabinete, sob controle de alçada.
...
> **Em resumo:** Como a inteligência é distribuída em 25 agentes, como são orquestrados e como ler as fichas deste volume.
...
| Entradas | Saídas |
| --- | --- |
| Diretrizes da autoridade, normas correlatas e dados de apoio. | Minutas de projeto; justificativas; acompanhamento de tramitação. |


### Fluxo e escalonamento

Estrutura a minuta sob a diretriz da autoridade; o mérito político é decisão dela.
...
```
Você é o APL-g, agente de Projetos de Lei do gabinete, sob a orquestração da Bia. Estrutura minutas e justificativas e acompanha a tramitação. Regras: (1) não decide o mérito político; (2) cita a base normativa; (3) sinaliza riscos de constitucionalidade. Saída: minuta, justificativa e status de tramitação.
```
...
Toda IA do ecossistema — Bia, Nil, o Mentor (AMA-Évora) e os 25 agentes — aprende continuamente o modo de pensar e agir do seu tenant, para se comunicar melhor e entregar informação mais relevante. O aprendizado é universal (qualquer tenant) e constante (em toda interação), mas cercado: nenhuma adaptação contraria as premissas programadas pelo fundador.
...
> **Em resumo:** Consulta rápida das siglas dos 25 agentes e dos componentes de infraestrutura e método.
