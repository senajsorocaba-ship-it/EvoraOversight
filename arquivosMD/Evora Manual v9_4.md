...
> Versão 9.4 · 07/07/2026 · numeração contínua · Confidencial — propriedade intelectual de Eng. de Sistemas Luiz Gonzaga Filho
...
| --- | --- | --- |
| Municipal | Diário Oficial de Sorocaba (via COM); **Cruzeiro do Sul online**; **Jornal Z Norte — seção Sorocabanices**; Jornal do Município; portal e pauta da Câmara de Sorocaba; PNCP (contratos/licitações) | MVP (L1) |
...
- **Veículos canônicos do tenant zero (leituras automáticas do briefing — decisão do fundador):** locais — **Cruzeiro do Sul (online)** e **Jornal Z Norte, seção "Sorocabanices"**, além do Jornal do Município (via COM — Coletores Oficiais Municipais); nacionais — **Globo/G1, GloboNews e Record News** (ingestão pelo texto dos portais; TV entra pela versão escrita) e outras mídias verificáveis. No MVP a coleta chega via agregador de notícias (Google News) com consultas dedicadas por veículo; o conector direto por site entra na fase COM. O repositório é **completável por qualquer assessor** (inclusão livre, aviso a todos) e a **exclusão só ocorre com alçada** — ver Porta de Fontes.
