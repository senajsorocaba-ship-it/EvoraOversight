...
**Fonte da pauta e honestidade de entrega.** A fonte canônica é a **pauta oficial da Câmara Municipal de Sorocaba** (e o texto dos PLs). A **leitura automática** depende de acesso à publicação da Câmara `[PENDENTE: forma de acesso/ingestão da pauta e dos PLs]`. Enquanto a automação não estiver pronta, a **assessoria cola a pauta** e a Bia monta a preparação em minutos — entrega assistida, sem prometer automação que ainda não existe (Princípio nº 1: verdade acima da conveniência).
...
| Acesso/ingestão da pauta e dos PLs da Câmara (Preparação da Sessão) | APL-g/ARI-g | Média |
